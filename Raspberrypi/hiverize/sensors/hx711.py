...
class HX711(Sensor):
	def __init__(self, dout_pin, pd_sck_pin, gain_channel_A=128, select_channel='A', interval = 1, name = 'HX711'):
	...
	def get_data(self):
		logger = logging.getLogger('hiverize.hx711')
		logger.debug('Read data')
		return self.get_weight_mean(1)